    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row justify-content-center" id="nothingToDisplay">
                    <p>Try broadening your search string</p>
                </div>
                <div class="row" id='projects-layout' data-current-page='1'>
                    ...
                    {{% for _project in category_projects %}}
                        ...
                        <div class="col-lg-6 ftco-animate project-card" data-project-url='{{ project[1].project_url }} '>
