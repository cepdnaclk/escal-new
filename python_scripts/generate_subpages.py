...
<section class="ftco-section">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="row justify-content-center mb-5 pb-3" id="heading">
                    <div class="col-md-7 heading-section ftco-animate text-center">
                        <h2 class="mb-4" id="whatIsDisplayed">{{{{ page.title }}}}</h2>
                        <h6 id="search-status"></h6>
                    </div>
                </div>
                <div class="row">
                    <img id="no-results" src="{{{{ 'assets/images/no_result.gif' | relative_url }}}}" alt="" style="display: none;" />
                </div>
                <div class="row" id='projects-layout' data-current-page='1'>
                    ...
                    {{% for _project in category_projects %}}
                        ...
                        <div class="col-lg-6 ftco-animate project-card" data-id='{{{{ _project }}}}' data-category='{{ project[1].category.title }}'
                            ...
                            <div class="blog-entry">
                                ...
                                <a href="{{{{ project.page_url }}}}" class="block-20" target="_blank"
                                    style="background-image: url('{{{{ proj_img | relative_url }}}}'); border-radius: 10px;">
                                </a>
                                <div class="text d-flex py-4">
                                    <div class="">
                                        <h3 class="heading"><a href="{{{{ project.page_url }}}}" target="_blank">{{{{ project.title }}}}</a></h3>
                                        ...
                                        {{% if size > 0 %}}
                                            <div class='d-flex flex-wrap' style="max-width: 350px;">
                                                ...
                                                {{% for member in project.team %}}
                                                    ...
                                                    {{% comment %}}
                                                    *
                                                    *    Change the following URL if the domain is changed.
                                                    *
                                                    {{% endcomment %}}
                                                    {{% assign people_page_url = "https://cepdnaclk.github.io/people.ce.pdn.ac.lk" %}}
                                                    {{% assign member_url = member[1].api_url | split: '/' | slice: -3, 3 %}}
                                                    <a href="{{{{ people_page_url }}}}/{{{{ member_url[0] }}}}/{{{{ member_url[1] | downcase }}}}/{{{{ member_url[2] }}}}" 
                                                        class="px-2" target="_blank" data-toggle="tooltip" data-placement="bottom" title="{{{{ member[1].name }}}}">{{{{ names[0] }}}}</a>
                                                {{% endfor %}}
                                            </div>
                                        {{% endif %}}
                ...
                <div class="row mt-5" id="pagination-controls">
                    <div class="col">
                        <div class="block-27 d-flex justify-content-center">
                            <ul>
                                {{% assign pages = category_projects.size | divided_by: 10.0 | ceil %}}
                                <li><span id='prev-button'>&lt;</span></li>
                                <li><span class="page-button" data-page='1'>1</span></li>
                                {{% for i in (2..pages) %}}
                                    <li><span class="page-button" data-page='{{{{ i }}}}'>{{{{ i }}}}</span></li>
                                {{% endfor %}}
                                <li><span id='next-button'>&gt;</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4 sidebar ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    <div class="categories">
                        <div id="accordion">
                            <div class="card">
                              <div class="card-header" id="headingOne" onmouseover="this.style.cursor='pointer'">
                              ...
                              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    {{% for category in site.data.project_categories limit: 5 %}}
                                    <li><a href="{{{{ site.url }}}}{{{{ site.baseurl }}}}{{{{ category[1].parent }}}}/{{{{ category[1].code }}}}" data-toggle="tooltip" data-placement="bottom" title="{{{{ category[0] }}}}">{{{{ category[0] | truncate:37 }}}} <span>({{{{ category[1].count }}}})</span></a></li>
                                    {{% endfor %}}
                                </div>
                              </div>
                            </div>
                            <div class="card">
                              <div class="card-header" id="headingTwo" onmouseover="this.style.cursor='pointer'">
                              ...
                              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    {{% for category in site.data.project_categories offset: 5 %}}
                                    <li><a href="{{{{ site.url }}}}{{{{ site.baseurl }}}}{{{{ category[1].parent }}}}/{{{{ category[1].code }}}}" data-toggle="tooltip" data-placement="bottom" title="{{{{ category[0] }}}}">{{{{ category[0] | truncate:37 }}}} <span>({{{{ category[1].count }}}})</span></a></li>
                                    {{% endfor %}}
                                </div>
                              </div>
