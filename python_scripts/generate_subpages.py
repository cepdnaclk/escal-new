                            ...
                            <div class="card">
                              ...
                              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <li><a href="{{{{ site.url }}}}{{{{ site.baseurl }}}}{{{{ category[1].parent }}}}/{{{{ category[1].code }}}}">{{{{ category[0] | truncate:30 }}}} <span>({{{{ category[1].count }}}})</span></a></li>
                                    {{% endfor %}}
                                </div>
                              </div>
                            </div>
                            <div class="card">
                              ...
                              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    <li><a href="{{{{ site.url }}}}{{{{ site.baseurl }}}}{{{{ category[1].parent }}}}/{{{{ category[1].code }}}}">{{{{ category[0] | truncate:37 }}}} <span>({{{{ category[1].count }}}})</span></a></li>
                                    {{% endfor %}}
                                </div>
                              </div>
                            </div>
